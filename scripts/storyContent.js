export const scenes = [
    ...
    },
    {
        ...
        body : [
            ...
            "Perhaps also unsurprising are retail investors' choices: the companies and funds offering the greatest returns. This chart shows retail investors' top ten stock picks in the early months of 2023. Nearly all are universal household names such as Tesla, Amazon, Apple, and Google - companies with which novice investors are already quite familiar. Within the opening months of 2023, retail investors had already poured over $23 billion into these equities. Hovering a wedge in the chart provides a <span style=\"font-weight:bold; color:#fa0; text-shadow:1px 1px 2px #eee;\">tooltip</span> summary of the equity.",
